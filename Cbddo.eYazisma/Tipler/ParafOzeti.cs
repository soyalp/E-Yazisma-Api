...
{
    /// <summary>
    /// ParafOzeti bileşeni bilgileri.
    /// </summary>
    public abstract class ParafOzeti : IDisposable
    {
        /// <summary>
        ...
        internal abstract CT_ParafOzeti CT_ParafOzeti { get; set; }
        /// <summary>
        /// ParafOzeti bileşenine özet ekler.
        /// </summary>
        ...
        /// <summary>
        /// ParafOzeti bileşenindeki özetleri döner.
        /// </summary>
    ...
    class ParafOzetiInternal : ParafOzeti
    {
        internal override CT_ParafOzeti CT_ParafOzeti { get; set; }

        public ParafOzetiInternal()
        {
            CT_ParafOzeti = new CT_ParafOzeti();
        }
        internal ParafOzetiInternal(CT_ParafOzeti parafOzeti)
        {
            CT_ParafOzeti = parafOzeti;
        }
        ...
        public override void Ekle(OzetModu ozetModu, Byte[] ozetDegeri, Byte[] ozetDegeriSha512, Uri uri, bool hariciBilesenMi = false)
        {
            ...
            if (CT_ParafOzeti.Reference == null)
                CT_ParafOzeti.Reference = new CT_Reference[0];
            List<CT_Reference> referanslar = CT_ParafOzeti.Reference.ToList();
            ...
            CT_ParafOzeti.Reference = referanslar.ToArray();
        }
        public override CT_Reference[] OzetleriAl()
        {
            return this.CT_ParafOzeti.Reference;
        }
        internal override void KontrolEt()
        {
            this.CT_ParafOzeti.KontrolEt();
        }
    }
}
